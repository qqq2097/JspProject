    ...
    <div class="footer-background">
      ...
      <footer class="footer">
        ...
        <div class="aside-wrap">
          <aside class="awards">
            <ul>
              <li><span>2016 고용 창출 100대 우수기업 4년 연속 표창</span></li>
              <li><span>2016 장애인도용촉진대회 장애인고용촉진 유공 포상</span></li>
              <li><span>2016 그린킹 캠페인 온실가스 저감 우수 모범 기업</span></li>
              <li><span>2016 농심품 상생협력 활동 우수사례 기업</span></li>
              <li><span>2016 대한민국 여성인재경영대상 우수사례 기업</span></li>
        ...
        <address class="address">
          ...
          <span>(주)스타벅스커피 코리아 대표이사 : 송 데이비드 효섭</span>
          <span>TEL : 1522-3232</span>
          <span>개인정보 책임자 : 장석현</span>
        </address>
        <small class="copyringt">&copy; Starbucks Coffee Company. All Rights Reserved.</small>
      </footer>
    </div>
</body>
</html>