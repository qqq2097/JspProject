	 ...
	 <div class="blondtb">
	     <table class="maintb">
	       <tr>
	        ...
	        <tr style="float: left;">
	       <%
	       for(SangpumDto dto:dao.getfoodList(12, 3))
	       {
	       %>
	         <td>
	         <br>
	         ...
	         <div class="img">
	           <div class="roastimg">
	             ...
	             'left=500px,width=420px,height=450px')">
	           </div>
	         </div>
	         <br>
	       ...
	       <tr style="float: left;">
	       <%
	       for(SangpumDto dto:dao.getfoodList(15, 3))
	       {
	       %>
	         <td>
	         <br>
	       ...
	       <tr style="float: left;">
	       <%
	       for(SangpumDto dto:dao.getfoodList(18, 3))
	       {
	       %>
	         <td>
	         <br>
	  ...
	  <div class="mediumtb">
	     <table class="maintb">
	       ...
	       <tr style="float: left;">
	       <%
	       for(SangpumDto dto:dao.getfoodList(21, 3))
	       {
	       %>
	         <td>
	         <br>
