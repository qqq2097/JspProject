	...
	<div style="border: 1px solid #BDBDBD;width: 1100px;height: 230px;padding: 30px;">
	  ...
	  <div class="filter">
	    ...
	    <ul>
	      ...
	      <li><input type="checkbox" name="chk2" class="cbx2" id="cbox" value="블론드 로스트">&nbsp;미디엄 로스트</li>
	      <li><input type="checkbox" name="chk3" class="cbx3" id="cbox" value="미디엄 로스트">&nbsp;다크 로스트</li>
	      <li><input type="checkbox" name="chk4" class="cbx4" id="cbox" value="다크 로스트">&nbsp;플레이버</li>
	    </ul>
	    </form>
	  </div>
	</div>
