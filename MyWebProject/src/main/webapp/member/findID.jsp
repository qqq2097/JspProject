...
<body>
	<div style="height: 100px;"></div>
	 <form action="" method="post" class="form-inline" onsubmit="return check(this)" name="findidform">
      	<div align="center">
      		...
      		<tr>
      			<td colspan="2" style="padding-top:20px;padding-bottom:20px; text-align:center; color:#6E6E6E; font-size: 2.5em;"><a>아이디가 기억나지 않으세요?</a></td>
      		</tr>
      		<tr>
      			<td colspan="2" style="padding-bottom:20px; text-align:center; color:gray; font-size: 1.7em;" class="line"><a>아래 인증 방법을 통해 아이디를 확인 하실 수 있습니다.</a></td>
      		</tr>
      		<tr>
