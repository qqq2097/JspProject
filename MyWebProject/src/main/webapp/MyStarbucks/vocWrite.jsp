...
.mysuggestion{background-image: url('../../MyStarbucks/image/voc.png');}
...
<section class="mysuggestion">
	<dl class="suggestion">
	<br>
	<dd style="font-size: 14px; ">스타벅스에서는 고객 여러분의 즐겁고 행복한 시간을 위해 정성을 다하고 있습니다.<br> 이용하시면서 불편한 점이나 개선이 필요한 점이 있다면 알려주세요. 좀 더 나은 서비스로 보답하겠습니다.
	<br><br><b style="color: #666666; padding: 0px 0px 0px 12xp; font-size: 10px;">※고객의 소리 운영시간 : 09:00 ~ 18:00 (연중 무휴)</b></dd>
	</dl>
	<p class="btn_suggestion_inquiry"><a href="index.jsp?main=../../MyStarbucks/voclist.jsp">나의 문의 내역 보기</a></p>
	</section>
</div>
			...
			<ul class="sub2">
				...
				<!-- 테이블 -->
								<div class="voc_input_tbl">
									...
									<table summary="분야, 답변 받으실 메일, 연락처, 장소, 제목, 내용, 파일첨부">
										...
										<tr>
											...
											<td>
												<div class="sel_wrap">
													...
													<p class="cate_sel_wrap">
														<label>대분류</label>&nbsp;&nbsp;
														<select name="CD_VOC_CAUSE_1" id="CD_VOC_CAUSE_1" onchange="categoryChange(this)" >
														<option>대분류</option>
										...
										<tr id="trEmail" >
											...
											<td>
												<div class="sel_wrap">
													<input class="mail_input" id="DS_CSTMR_EMAIL1"  name="DS_CSTMR_EMAIL1" type="text" value=''>&nbsp;
													<p class="mail_at">@</p>&nbsp;&nbsp;
													<input class="mail_input" id="DS_CSTMR_EMAIL2"  name="DS_CSTMR_EMAIL2" type="text" value=''>&nbsp;
										...
										<tr>
											<th scope="row">이용 매장<img alt="필수입력" src="//image.istarbucks.co.kr/common/img/common/bullet_star_red.gif"></th> <!-- 20210809 수정 -->
											<td>
												<div class="tbl_radio_wrap">
												...
												<div class="sel_wrap mt10">
													...
													<div class="pick_date_each">
														<div class="pick_date_each_left"><input  type="date" id="pickDate1" name="DT_VISIT_STR" title="원하는 날짜를 선택해 주세요."></div>
													</div>
												</div>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												...
												<textarea class="textArea" id="DS_VOC_CN" name="DS_VOC_CN" onpaste="fnPaste(); return false;" oncopy="fnCopy(); return false;" 
											        style="width: 553px; height:131px;" placeholder="관계 법령에 저촉되거나 사회통념 등에 어긋나는 내용(예: 개인정보 보안, 불충분한 증거/귀책 사유에 대한 개인 음해성/음란성 비방, 의도적인 업무 방해 등) 또는 광고성 게시물은 별도의 사전 통보 없이 답변이 되지 않을 수 있으며, 등록된 의견은 처리가 시작되면 수정이 불가하오니 이 점 양지하여 주시기 바랍니다."></textarea>
								...
								<div class="voc_info_input_btns">
									<ul>
										<li class="voc_info_input_btn1"><a href="#none" onclick="">고객의 소리 등록 하기</a></li>
									</ul>
								</div>
