...
%>
	...
	<form action="findIDphoneCheck.jsp" method="post" class="form-inline" style="width : 450px;text-align: center;">
...
<%
	...
	<%
		...
		style="margin-left: 200px;"onclick="location.href='findIDphoneCheck.jsp'">다시하기</button>
