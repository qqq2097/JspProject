...
%>
	...
	<form action="findPassemailCheck.jsp" method="post" class="form-inline" style="width : 450px;text-align: center;">
...
<%
	...
	<script type="text/javascript">
		opener.location.href="../starbucks_clone/starbucks_clone/index.jsp?main=../../member/resetPass.jsp";
	...
	<%
		...
		style="margin-left: 200px;"onclick="location.href='findPassemailCheck.jsp'">다시하기</button>
